...
final class AuthManager: NSObject, ObservableObject, ASWebAuthenticationPresentationContextProviding {
        ...
        do {
            ...
            let callbackURL = try await withCheckedThrowingContinuation {
                ...
                let session = ASWebAuthenticationSession(
                    ...
                    guard let url else { cont.resume(throwing: NKError.cancelled); return }
            ...
            isLoading = false
            if case NKError.cancelled = error { return }
            errorMessage = friendlyError(error)
        }
    }
    ...
    private func exchangeDiscordCode(_ code: String, verifier: String) async throws -> String {
        ...
        let encoded = Endpoint.redirectUri
    ...
    func logout() {
        ...
        authToken = nil; currentUserId = nil; currentUsername = nil
        currentAvatar = nil; isLoggedIn = false
    }
